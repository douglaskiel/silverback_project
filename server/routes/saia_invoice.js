...
router.post('/insert_saia_invoice', function(req, res) {
	if (req.user_role === 'Admin' || req.user_role === 'Editor') {
		var query = "INSERT INTO saia_invoices (carrier_name, pro_number, sender, sender_zip, receiver, receiver_zip, client_name, ship_date, process_date, base_charge, carrier_id, discount_percent, fsc_dollar, old_cost, old_fsc_dollar, old_total_cost_dollar, new_cost, new_fsc_dollar, new_total_cost_dollar, savings_dollar, client_id, discount_ammount) VALUES ('" + req.body.carrier_name + "', '" + req.body.pro_number + "', '" + req.body.sender + "', '" + req.body.sender_zip + "', '" + req.body.receiver + "', '" + req.body.receiver_zip + "', '" + req.body.client_name + "', '" + req.body.ship_date + "', '" + req.body.process_date + "', '" + req.body.base_charge + "', '" + req.body.carrier_id + "', '" + req.body.discount_percent + "', '" + req.body.fsc_dollar + "', '" + req.body.old_cost + "', '" + req.body.old_fsc_dollar + "', '" + req.body.old_total_cost_dollar + "', '" + req.body.new_cost + "', '" + req.body.new_fsc_dollar + "', '" + req.body.new_total_cost_dollar + "', '" + req.body.savings_dollar + "', '" + req.body.client_id +"', '" + req.body.discount_ammount + "')";
		db.query(query).spread(function(result, metadata) {
...
router.put('/update_saia_invoice', function(req, res) {
	if (req.user_role === 'Admin' || req.user_role === 'Editor') {
		var query = "UPDATE saia_invoices SET carrier_name = '" + req.body.carrier_name + "', pro_number='" + req.body.pro_number + "', sender ='" + req.body.sender + "', sender_zip ='" + req.body.sender_zip + "', receiver='" + req.body.receiver + "', receiver_zip='" + req.body.receiver_zip + "', client_name='" + req.body.client_name + "', ship_date='" + req.body.ship_date + "', process_date='" + req.body.process_date + "', base_charge='" + req.body.base_charge + "', carrier_id='" + req.body.carrier_id + "', discount_percent='" + req.body.discount_percent + "', fsc_dollar='" + req.body.fsc_dollar + "', old_cost='" + req.body.old_cost + "', old_fsc_dollar='" + req.body.old_fsc_dollar + "', old_total_cost_dollar='" + req.body.old_total_cost_dollar + "', new_cost='" + req.body.new_cost + "', new_fsc_dollar='" + req.body.new_fsc_dollar + "', new_total_cost_dollar='" + req.body.new_total_cost_dollar + "', savings_dollar='" + req.body.savings_dollar + "', client_id='" + req.body.client_id + "', discount_ammount='" + req.body.discount_ammount + "' WHERE saia_id=" + req.body.saia_id;
		db.query(query).spread(function(result, metadata) {
